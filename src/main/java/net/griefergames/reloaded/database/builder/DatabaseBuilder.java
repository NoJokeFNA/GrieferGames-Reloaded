...
public class DatabaseBuilder {
  public void createTable() {
    ...
    val boosterSqlQuery =
        "CREATE TABLE IF NOT EXISTS `gg_booster` ("
            + "  id               INT(11)     NOT NULL AUTO_INCREMENT,"
     ...
     */
    val clanSqlQuery =
        "CREATE TABLE IF NOT EXISTS `gg_clans` ("
            + "  id               INT(11)      NOT NULL AUTO_INCREMENT,"
     ...
     */
    val cooldownSqlQuery =
        "CREATE TABLE IF NOT EXISTS `gg_cooldown` ("
            + "  id                   INT(11)      NOT NULL AUTO_INCREMENT,"
     ...
     */
    val playerHolographicSql =
        "CREATE TABLE IF NOT EXISTS `gg_playerholo` ("
            + "  id               INT(11)     NOT NULL AUTO_INCREMENT,"
