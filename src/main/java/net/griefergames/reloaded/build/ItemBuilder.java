...
public class ItemBuilder {
  ...
  public ItemBuilder setSkullOwner(@NotNull final OfflinePlayer owner) {
    @NotNull
    final SkullMeta skullMeta = (SkullMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
  ...
  /**
   * Sets the dye color on an item. <b>* Notice that this doesn't check for item type, sets the
   * literal data of the dyecolor as durability.</b>
   *
  ...
  public ItemBuilder setLeatherArmorColor(@NotNull final Color color) {
    @NotNull
    final LeatherArmorMeta armorMeta =
        (LeatherArmorMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
  ...
  public ItemBuilder setBook(
    ...
    @NotNull
    final BookMeta bookMeta = (BookMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
  ...
  public ItemBuilder setBanner(@NotNull final List<Pattern> patterns) {
    @NotNull
    final BannerMeta bannerMeta = (BannerMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
   ...
   * @param ignoreLevelRestriction Set the boolean to true, if you want to ignore the level
   *     restriction
   */
  public ItemBuilder addStoredEnchant(
      @NotNull final Enchantment enchantment,
      final int level,
      final boolean ignoreLevelRestriction) {
    @NotNull
    final EnchantmentStorageMeta storageMeta =
        (EnchantmentStorageMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
  ...
  public ItemBuilder removeStoredEnchant(@NotNull final Enchantment enchantment) {
    ...
    final EnchantmentStorageMeta storageMeta =
        (EnchantmentStorageMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
    if (storageMeta.hasStoredEnchant(enchantment)) storageMeta.removeStoredEnchant(enchantment);
  ...
  public ItemBuilder setMapScaling(final boolean value) {
    ...
    if (!mapMeta.isScaling()) mapMeta.setScaling(value);
   ...
   */
  public ItemBuilder addCustomEffect(
      @NotNull final PotionEffect potionEffect, final boolean overwrite) {
    @NotNull
    final PotionMeta potionMeta = (PotionMeta) Objects.requireNonNull(this.itemStack.getItemMeta());
