...
public class ScoreboardBuilder {
   ...
   *
   * @param objectiveName the {@code objectiveName} of the new {@link Scoreboard} - {@link
  ...
  public ScoreboardBuilder(
      @NotNull final String objectiveName,
      @NotNull final DisplaySlot displaySlot,
    ...
    this.objective =
        this.scoreboard.registerNewObjective(objectiveName, "dummy", coloredMessage(displayName));
  ...
  public static void removeEntry(
      @NotNull final Player player, @NotNull final String team, @NotNull final String entry) {
  ...
  public static void updateTeam(
      @NotNull final Player player, @NotNull final String team, @NotNull final String prefix) {
    Objects.requireNonNull(player.getScoreboard().getTeam(team))
        .setPrefix(staticColoredMessage(prefix));
  }
   ...
   * @param entry set the {@code entry} of the {@code scoreboard}. Please use only §1, §2 (...), or
   *     {@link ChatColor}
   * @param score set the {@code score} in the following order
   * @return returns the method
   */
  public ScoreboardBuilder addTeam(
      @NotNull final String teamName,
      @NotNull final String prefix,
